 ...
 */
public class HostNameFormatter extends MultistepFormatter {
     ...
     */
    public HostNameFormatter(String pattern) {
     ...
     */
    public HostNameFormatter(String pattern, String colors) {
